...
| Build configuration (menu & manual) | [build-config](build-config.md) | TUI vs manual fragment chaining, Product/Dev auth profiles, and local verification. |
...
| Maintenance & operations | [maintenance](maintenance.md) | Flashing, network defaults, Product/Dev credential model, CR 1.11 baseline, and firmware operations. |
