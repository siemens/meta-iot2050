...
# Privileged socket service for account and failed-login operations.
# SO_PEERCRED and iot2050-admin enforce authorization before any helper or
# account command is executed; passwords are never written to logs.
