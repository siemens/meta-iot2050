...
DESCRIPTION = "IOT2050 login security baseline (CR 1.11)"

DEBIAN_DEPENDS = "libpam-runtime, libpam-modules, libpam-pwquality, openssh-server, passwd, python3, systemd"
